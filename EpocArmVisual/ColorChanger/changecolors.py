...
def ColorAdjust(self, value):
	quality_color = {"0": 0,"1": 10,"2": 20,"3": 30,"4": 40,"5": 80,"6": 90,"7": 100,}
...
def ColorBatt(self, BattValue):
    ...
    if BattValue <= 20:
       ...
       palette.setColor(QtGui.QPalette.Highlight, QtGui.QColor(QtCore.Qt.blue))
       pal.setPalette(palette)
    elif BattValue >= 90:
       palette.setColor(QtGui.QPalette.Highlight, QtGui.QColor(QtCore.Qt.green))
       pal.setPalette(palette)

def ColorChannelQuality(self, QualityCH1, QualityCH2, QualityCH3, QualityCH4, QualityCH5):
    palette = QtGui.QPalette()
